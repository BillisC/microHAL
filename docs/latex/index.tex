\chapter{STM32\+F446xx Drivers}
\hypertarget{index}{}\label{index}\index{STM32F446xx Drivers@{STM32F446xx Drivers}}
...
\item Provides simple driver implementations
\item Uses CMSIS where needed
\item Tries to be MISRA C (2023) compliant {\itshape can\textquotesingle{}t be sure though}
\item Attempts to be cross-\/compatible {\itshape cough}
\item Serves as a template for future projects
\end{DoxyItemize}
